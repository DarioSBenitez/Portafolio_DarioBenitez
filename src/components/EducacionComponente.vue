...
const educacion = ref([
  {fecha: '2024', title: 'Técnicatura Universitaria en Programacion', descripcion: 'Áreas de Competencia Profesional: Operación y programación avanzada de sistemas informáticos, desarrollo de aplicaciones en múltiples lenguajes de programación, y análisis integral y control de sistemas de información.', enlace:'https://www.frsr.utn.edu.ar/institucional/'},
  {fecha: '2023', title: 'Desarrollador Back End', descripcion: 'Trabajé en Pampa Technologies, donde participé en el diseño e implementación de sistemas de manejo de materiales automatizados, integrando soluciones de software para Vehículos Guiados Automáticamente (AGVs) y robots móviles. Colaboré en proyectos de ingeniería personalizados que combinaban software avanzado con hardware adaptado para optimizar el flujo de producción en líneas de ensamblaje. En este rol, me enfoqué en desarrollar sistemas robustos y eficientes que maximizan la seguridad y la precisión en entornos industriales automatizados.', enlace:'https://pampatech.com/'},
  {fecha: '2022', title: 'Desarrollador Back End – NorthWind Technical Services (2022)', descripcion: 'En 2022, en NorthWind Technical Services, participé en el desarrollo y optimización de sistemas de control industrial para procesos automatizados. Colaboré en la creación de software para la gestión de plantas de manufactura, enfocándome en la integración de sistemas de control y la implementación de soluciones que mejoran la eficiencia operativa. Mi trabajo incluyó la programación de módulos personalizados para la supervisión en tiempo real de la producción y el diseño de interfaces para facilitar la interacción con el equipo de ingeniería y los operadores.', enlace:'https://www.northwindts.com/es/'},
  {fecha: '2021', title: 'Proyecto personal: Sistema inteligente de monitoreo y control para invernaderos.', descripcion: 'Desarrollé un sistema que utiliza sensores IoT para monitorear las condiciones ambientales de un invernadero, como temperatura, humedad y niveles de CO2. Integré algoritmos de inteligencia artificial en Python para predecir los cambios climáticos y optimizar el uso de recursos (como la energía y el agua). Utilicé microcontroladores para recoger los datos en tiempo real, que luego eran procesados por el sistema AI para hacer recomendaciones automáticas y controlar dispositivos de manera eficiente, mejorando la productividad y reduciendo costos operativos.', enlace:'https://ar5iv.labs.arxiv.org/html/2107.05464'},
  {fecha: '2020', title: 'Curso de Introducción a la Programación en el Informatorio Resistencia Chaco', descripcion: 'Completé un curso en línea sobre fundamentos de programación, donde aprendí a trabajar con Python y uno de sus Framework: Django, creando sistemas con bases de datos relacionales.', enlace:'https://campus-informatorio.chaco.gob.ar/'}
]);
</script>
...
ul {
  ...
  --line-w: 0.30rem; /* Ancho de la línea que conecta los elementos de la lista */
