<script setup>
import proyecto1 from '/src/assets/domotica.png';
import proyecto2 from '/src/assets/arduino.png';
import proyecto3 from '/src/assets/dario.png';
import proyecto4 from '/src/assets/interconexion.png';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Domótica para Residencias familiares (2023)",
        descripcion: "Cree proyectos de automatización para el control total y parcial de viviendas",
        projectoLink: "https://ar.images.search.yahoo.com/search/images?p=proyectos+de+domotica&fr=mcafee&type=E210AR91215G0&imgurl=https%3A%2F%2F3.bp.blogspot.com%2F-hCYJ5YG0y9A%2FUhFcpzXSrqI%2FAAAAAAAAAo8%2FUzVx54xL-wQ%2Fs1600%2FMaqueta_casa_domotica_arduino_jetutoriales_by_Jeovani_Martinez_2.jpg#id=0&iurl=https%3A%2F%2F3.bp.blogspot.com%2F-hCYJ5YG0y9A%2FUhFcpzXSrqI%2FAAAAAAAAAo8%2FUzVx54xL-wQ%2Fs1600%2FMaqueta_casa_domotica_arduino_jetutoriales_by_Jeovani_Martinez_2.jpg&action=click",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Desarrollo de control de temperatura para centros de salud con modulos raspberry y arduino (2022)",
        descripcion: "Diseñé y desarrollé controladores de temperatura asistidos modulos electrónicos y controlados por internet desde dispositivos móviles",
        projectoLink: "https://soltecinstrumentos.com.ar/temperatura/controladores-de-temperatura/?srsltid=AfmBOopBqYgC-tHcevfR_rIr7VyT0SNy28n2cbP3G3DWth6h-toMC-AR",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
        id: 3,
        src: proyecto3,
        titulo: "Web personal en un sitio gratis en español, actualmente no funciona bien (2021)",
        descripcion: "Construí una web personal para un trabajo pasado que tenía como técnico electrónico en un taller de televisores.",
        projectoLink: "https://www.electronicabenitez.es.tl",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
        id: 4,
        src: proyecto4,
        titulo: "Aplicación para conexion IOT (2020)",
        descripcion: "Diseñe y construi varias aplicaciones multiplataforma para control de dispositivos y cosas",
